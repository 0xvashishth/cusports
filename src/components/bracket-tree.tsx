...
function buildSections(bracketMatches: BracketMatch[]): BracketSection[] {
  ...
  const sideOrder: BracketSide[] = ["winners", "losers", "grand_final", "grand_final_reset", "third_place", "single"]
...
function BracketSection({
  ...
  const isSingleBracket =
    ...
    section.side === "grand_final_reset" ||
  ...
  return (
    <Card
      ...
      className={cn(
        ...
        isBye && "bg-muted/30",
        match.bracket_side === "grand_final_reset" && match.status === "pending" && "opacity-40",
      )}
    >
            ...
            {match.bracket_side === "single" || match.bracket_side === "winners"
              ...
              : match.bracket_side === "losers"
                ...
                : match.bracket_side === "grand_final"
                  ? "GF"
                  : match.bracket_side === "grand_final_reset"
                    ? "GFR"
                    : "3P"}
          </span>
          {completed && (
